...
class AllCategoriesScreen extends StatefulWidget {
  ...
  const AllCategoriesScreen({super.key, required this.categoryList});
                          ...
                          children: [
                            CustomCard(
                              ...
                              child: CachedNetworkImage(
                                  imageUrl:
                                      '${Urls.imgUrl}${category.image!.path}'),
                            ),
                            Gap(4.h),
                            Text(
                              '${category.name}',
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      ...
                      onTap: () {
                        Get.to(
                            () => FinalProductDetailsScreen(product: cProduct));
                      },
                      child: CustomCard(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                          image: CachedNetworkImageProvider(
                                              '${Urls.imgUrl}${cProduct.images![0].path}'),
                                          fit: BoxFit.cover),
                                    ),
                                  ),
                            ...
                            Padding(
                              padding: EdgeInsets.only(left: 8.w),
                              child: Text(
                                  '${Urls.takaSign}${cProduct.offerPrice}',
                                  style: Get.textTheme.bodySmall),
                            ),
                            Gap(8.h),
                          ],
