              ...
              onPressed: () {
               if(Get.find<AddressViewController>().addressList.isNotEmpty){
                 Get.to(() => CheckOutScreen(
                   cartItemList: _cartItemController.cartItems,
                   totalAmount: _cartItemController.calculateSubTotal(),
                 ));
               }else{
                 Get.to(()=> const AddressManagementScreen(title: AppUrls.addAddress));
               }
              },
              buttonName: 'Checkout',
              width: 146.w)
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage(
                                    '${AppUrls.imgUrl}${cartItem.products!.images![0].path}'),
                                fit: BoxFit.cover
                              ),
                            ),
                          ),
                        ...
                        Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Text(
                                      '${AppUrls.takaSign}${cartItem.products!.offerPrice.toString()}',
                                      style: Get.textTheme.bodyMedium!
  ...
  Container _buildProductIncrementDecrement(int index) {
    return Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
          ...
          GetBuilder<CartItemController>(builder: (controller) {
            return Text('${controller.cartItems[index].quantity}',
                style: Get.textTheme.bodyMedium);
          }),
          InkWell(
